...
Figure 2 shows the estimated probability of getting cancer, which is calculated from the estimated model in part (b). We can calculated the probability by using $\frac{\exp\left(\boldsymbol{x\hat{\beta}}\right)}{1 + \exp\left(\boldsymbol{x\hat{\beta}}\right)}$.
